...
4. Run the POST request - to add book
5. Run the DELETE request - to remove book
6. Run the PUT request - to update quantity of book
7. (Refresh the browser tab after running each request to see the changes made)
